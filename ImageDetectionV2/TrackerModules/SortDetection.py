...
def detectObject(mode, video=None, save_video=False, show_video=True):
    ...
    while True:
        if not paused:
            ...
            if frame_idx % 15 == 0:
                # Perform object detection every 15th frame
                ...
                for i in range(face_detections.shape[2]):
                    ...
                    if confidence > 0:
                        ...
                        if person_idx is None:
                            ...
                            # Update existing person's results
        ...
        if not people_list_queue.empty():
            ...
            with open('output/people.csv', mode='w', newline='') as file:
                ...
                for person in sorted(current_people_list, key=lambda p: p.person_id):
                    ...
                    csv_writer.writerow([timestamp, person.person_id, gender, age, photo_path])
